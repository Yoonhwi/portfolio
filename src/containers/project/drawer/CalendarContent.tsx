  ...
  return (
    <Flex direction={"column"} gap={"20"} fontSize={"18px"}>
      ...
      <Flex direction={"column"} gap={"4"}>
        ...
        <UnorderedList spacing={"4"}>
          <ListItem>
            React-Query를 활용하여 CRUD 기능을 구현했습니다.
            <br /> 이를 통해 서버 상태를 효율적으로 관리하고, 데이터 페칭과
            캐싱을 자동화하여 UX를 향상시켰습니다.
            <br /> 특히, 데이터가 변경될 때마다 자동으로 최신 상태를 반영하여
            사용자가 항상 최신 정보를 볼 수 있도록 했습니다.
            <br /> 또한, 불필요한 리렌더링을 줄이고 코드의 복잡성을 낮춰
            유지보수가 용이해졌습니다.
          </ListItem>
        </UnorderedList>
      </Flex>
