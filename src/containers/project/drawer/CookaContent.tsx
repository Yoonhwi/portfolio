...
const CookaContent = () => {
  return (
    <Flex direction={"column"} gap={"12"} fontSize={"18px"}>
      ...
      <Flex direction={"column"} gap={"12"}>
        ...
        <Flex direction={"column"} gap={"4"}>
          ...
          <Flex boxShadow={"md"}>
            <Box flex={1}>
              <Image src="cooka/cookalogin.png" alt="cookalogin" flex={1} />
            </Box>
            <Box flex={1}>
              <Image src="cooka/cookajoin.png" alt="cookajoin" flex={1} />
            </Box>
          </Flex>
          ...
          <UnorderedList spacing={"2"}>
            ...
            <ListItem>
              Crypto모듈을 사용하여 비밀번호를 암호화하여 저장하고, Salt
              암호화를 통해 보안성을 높였습니다.
            </ListItem>
            <ListItem>
        ...
        <Flex gap={"4"}>
          ...
          <Flex gap={2} direction={"column"} flex={1} my={"12"}>
            ...
            <UnorderedList spacing={"2"}>
              <ListItem>
                이미지나, 폰트 스타일 등 게시글의 퀄리티를 높이기 위해
                text-area를 대신하여 React-quill 라이브러리를 사용하였습니다.
              </ListItem>
              <ListItem>
        ...
        <Flex direction={"column"} gap={"4"}>
          ...
          <UnorderedList spacing={"2"}>
            ...
            <ListItem>
              검색어를 입력하면 해당 검색어를 포함하는 게시물을 찾아서
              보여줍니다.
            </ListItem>
            <ListItem>
        ...
        <Flex direction={"column"} gap={"4"}>
          ...
          <UnorderedList spacing={"2"}>
            <ListItem>
              ...
              무지했기에 공부가 필요했습니다. 프로젝트를 진행하며 해당 기술
              스택에 대해 이해도가 높아졌다고 생각합니다.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              또한, TypeScript를 사용하여 런타임 에러를 최소화하는 방법을 배울
              수 있었습니다.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              반복적인 코드를 사용하면 가독성이 떨어지고 수정이 매우
              힘들어진다는 걸 알게 됐고, 코드에 대한 설계와 리팩토링의 중요성을
              깨닫게 되었습니다.
            </ListItem>
          </UnorderedList>
        </Flex>
